...
function WaveEffect(props) {
  ...
  return (
    <>
      <div className="waves">
        <div className="waves__wave" id="wave1"></div>
        <div className="waves__wave" id="wave2"></div>
        <div className="waves__wave" id="wave3"></div>
        <div className="waves__wave" id="wave4"></div>
      </div>
    </>
  );
}
